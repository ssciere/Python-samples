...
def opening_banner():
    ...
    print(" a great tool to help you figure out what to do in Durham!")
    print()
...
def gather_user_preferences(): #This is where the user answers the questions about their perfect activity
    ...
    print("Answer each question on a scale of 1 to 10 and press <enter>")
    print("(Ten is highest and 1 is lowest)")
    print()
